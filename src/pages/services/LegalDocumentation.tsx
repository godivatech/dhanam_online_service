        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-7">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">Legal<br /><span className="text-[#E5A019] italic">Documentation</span></h1>
              <p className="text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed">Comprehensive legal drafting, review, notarisation, and advisory services — precise documentation that protects your interests in every transaction.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl">
                <img 
                  src="/images/services/Legal Documentation and Advisory.png" 
                  alt="Legal Documentation and Advisory" 
