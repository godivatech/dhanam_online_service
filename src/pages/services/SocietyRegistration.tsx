    ...
    <Layout>
      <section className="relative bg-[#102F56] text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex items-center gap-2 text-xs text-white/50 mb-10 uppercase tracking-wider flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#E5A019]">Society Registration</span>
          </div>
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-7">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">Society<br /><span className="text-[#E5A019] italic">Registration</span></h1>
              <p className="text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed">Complete society registration under the Tamil Nadu Societies Registration Act — from Memorandum drafting to Certificate of Registration.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl">
                <img 
                  src="/images/services/Society Registration.png" 
                  alt="Society Registration" 
      ...
      <section className="py-24 bg-[#FAFBFC]">
        <div className="container mx-auto px-6 lg:px-12">
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <div className="mb-12">
              <p className="text-xs uppercase tracking-[0.35em] text-[#E5A019] font-semibold mb-4">Society Types</p>
              <div className="w-12 h-0.5 bg-[#E5A019] mb-8" />
              <h2 className="font-serif text-4xl font-bold text-[#102F56]">Societies We Register</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6 mb-16">
              {TYPES.map((t) => (
                <motion.div key={t.title} variants={fadeUp} className="p-8 bg-white border border-[#DCE3EA] border-l-4 border-l-[#E5A019] hover:shadow-xl transition-all">
                  <h3 className="font-serif text-xl font-bold text-[#102F56] mb-3">{t.title}</h3>
                  <p className="text-[#334155] leading-relaxed">{t.desc}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-[#102F56] text-white border-t border-[#DCE3EA]/20">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <h2 className="font-serif text-4xl font-bold text-white mb-6">Ready to Register Your Society?</h2>
          <p className="text-white/80 text-lg mb-10 max-w-xl mx-auto">Book a free consultation. Our team handles every document and every step from formation to certificate.</p>
          <Link href="/book-consultation" className="inline-flex items-center bg-[#123E73] hover:bg-[#092747] text-white px-10 py-4 font-bold text-sm uppercase tracking-wider border border-[#E5A019]/40 shadow-xl transition-all" data-testid="button-cta-society">
