      ...
      <section className="relative bg-[#102F56] text-white py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-bold leading-tight mb-6">Society<br /><span className="text-[#E5A019] italic">Registration</span></h1>
            <p className="text-white/80 text-xl max-w-2xl leading-relaxed">Complete society registration under the Tamil Nadu Societies Registration Act — from Memorandum drafting to Certificate of Registration.</p>
          </motion.div>
        </div>
      </section>
