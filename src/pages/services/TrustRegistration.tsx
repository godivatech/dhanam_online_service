...
export default function TrustRegistration() {
  return (
    <Layout>
      <section className="relative bg-[#102F56] text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex items-center gap-2 text-xs text-white/40 mb-10 uppercase tracking-wider flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#E5A019]">Trust Registration</span>
          </div>
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-7">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">Trust<br /><span className="text-[#E5A019] italic">Registration</span></h1>
              <p className="text-white/70 text-lg md:text-xl max-w-2xl leading-relaxed">End-to-end trust formation services — from Trust Deed drafting to final registration certificate, with expert guidance on tax exemptions and compliance.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl">
                <img 
                  src="/images/services/Trust Registration.png" 
      ...
      <section className="py-24 bg-[#FAFBFC]">
        <div className="container mx-auto px-6 lg:px-12">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <p className="text-xs uppercase tracking-[0.35em] text-[#E5A019] font-semibold mb-4">Why Register</p>
            <div className="w-12 h-0.5 bg-[#E5A019] mb-8" />
            <h2 className="font-serif text-4xl font-bold text-[#102F56]">Benefits of Trust Registration</h2>
          </motion.div>
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {BENEFITS.map((b) => (
              <motion.div key={b.title} variants={fadeUp} className="p-8 bg-white border border-[#DCE3EA] border-l-4 border-l-[#E5A019] hover:shadow-xl transition-all duration-300">
                <h3 className="font-serif text-xl font-bold text-[#102F56] mb-3">{b.title}</h3>
                <p className="text-[#334155] text-sm leading-relaxed">{b.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-[#102F56] text-white">
        <div className="container mx-auto px-6 lg:px-12">
      ...
      <section className="py-24 bg-[#FAFBFC]">
        <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
          ...
          <div className="border border-[#DCE3EA] divide-y-0">
      ...
      <section className="py-24 bg-[#102F56] text-white border-t border-[#DCE3EA]/20">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          <h2 className="font-serif text-4xl font-bold text-white mb-6">Ready to Register Your Trust?</h2>
          <p className="text-[#DCE3EA]/80 text-lg mb-10 max-w-xl mx-auto">Book a free consultation and let our experts guide your trust formation from deed drafting to final registration.</p>
          <Link href="/book-consultation" className="inline-flex items-center bg-[#123E73] hover:bg-[#092747] text-white px-10 py-4 font-bold text-sm uppercase tracking-wider transition-all shadow-xl border border-[#E5A019]/40" data-testid="button-cta-trust">
