...
const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  "General": [
    ...
    { q: "Do you offer home visits or consultations outside your office?", a: "Yes, for clients who are unable to visit our office due to health, mobility, or scheduling constraints, we offer home visit consultations in Madurai and its suburbs. For clients in other districts, we conduct detailed video consultations and coordinate all documentation via courier and digital submission where legally permissible. Please contact us to arrange an alternative consultation format." },
