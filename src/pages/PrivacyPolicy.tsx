      ...
      <section className="relative bg-[#102F56] text-white py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex items-center gap-2 text-xs text-white/50 mb-10 uppercase tracking-wider">
            ...
            <span className="text-[#E5A019]">Privacy Policy</span>
          </div>
      ...
      <section className="py-20 bg-[#FAFBFC]">
        <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="text-[#334155] leading-relaxed text-lg mb-12">
            ...
            <div className="space-y-10">
              {SECTIONS.map((s, i) => (
                <div key={s.title} className="bg-white border border-[#DCE3EA] border-l-4 border-l-[#E5A019] p-8 shadow-sm">
